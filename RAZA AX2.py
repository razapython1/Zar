...
import webbrowser
webbrowser.open('https://t.me/razapython')
...
TOKEN_FILE = 'tl.txt'
pyraza_domain = '@gmail.com' 

P = '\x1b[1;97m'        # Bright White
B = '\x1b[1;94m'        # Bright Blue
O = '\x1b[1;96m'        # Bright Cyan
Z = '\x1b[1;38;5;226m'  # Bright Yellow (changed from gray)
X = '\x1b[1;38;5;214m'  # Vivid Orange (changed from yellow)
F = '\x1b[1;38;5;46m'   # Bright Green (changed from dim green)
Z = '\x1b[1;38;5;196m'  # Bright Red (changed from gray/red)
L = '\x1b[1;38;5;201m'  # Bright Magenta (changed from pink)
C = '\x1b[1;38;5;213m'  # Bright Pink (changed from dim purple)
A = '\x1b[1;38;5;51m'   # Bright Sky Blue (changed from dim gray)
P = '\x1b[1;38;5;231m'  # Pure White
J = '\x1b[1;38;5;208m'  # Bright Orange
J1 = '\x1b[1;38;5;203m' # Vivid Red-Orange
J2 = '\x1b[1;38;5;198m' # Bright Pink-Red
J21 = '\x1b[1;38;5;199m'# Electric Pink
J22 = '\x1b[1;38;5;209m'# Light Orange
F1 = '\x1b[1;38;5;82m'  # Bright Lime Green
C1 = '\x1b[1;38;5;123m' # Bright Aqua
P1 = '\x1b[1;38;5;158m' # Light Mint Green
P2 = '\x1b[1;38;5;226m' # Bright Yellow
E = '\x1b[1;38;5;196m'  # Bright Red
Y = '\x1b[1;38;5;226m'  # Bright Yellow
Z = '\x1b[1;38;5;196m'  # Bright Red
X = '\x1b[1;38;5;214m'  # Bright Orange
Z1 = '\x1b[1;38;5;160m' # Darker Red
F = '\x1b[1;38;5;46m'   # Bright Green
A = '\x1b[1;38;5;39m'   # Bright Blue
C = '\x1b[1;38;5;201m'  # Bright Magenta
S = '\x1b[1;38;5;51m'   # Bright Cyan
G = '\x1b[1;38;5;33m'   # Deep Sky Blue
M = '\x1b[1;38;5;255m'  # Bright White
B = '\x1b[1;38;5;39m'   # Bright Blue (changed from white)'
...
logo = render('RAZAPY', font='block', colors=['blue', 'white'], align='left', space=True)
print("\x1b[1;39m—" * 60)
print(logo)      
print("\x1b[1;39m—" * 60)
...
user_id = input("𝗨𝗦𝗘𝗥_𝗜𝗗: ")


ID = user_id
print('') 
TOKEN = input("𝗕𝗢𝗧_𝗧𝗢𝗞𝗘𝗡:") 
print('') 
os.system('cls' if os.name == 'nt' else 'clear')


logo = render('RAZAPY', font='block', colors=['green', 'white'], align='left', space=True)
print("\x1b[1;39m—" * 60)
print(logo)      
print("\x1b[1;39m—" * 60)

print('𝗪𝗔𝗜𝗧 𝗙𝗢𝗥 𝗧𝗢𝗢𝗟 𝗧𝗢 𝗥𝗨𝗡.........')
...
\033[1;38;5;39m
  ...
  ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
\033[0m
\033[1;96m@RAZAPYTHON @PYRAZA  🔄\033[0m

\033[1m
HITS       = [\033[1;32m{hits}\033[0m]
BAD IG     = [\033[1;31m{bad_insta}\033[0m]
BAD EMAIL  = [\033[1;33m{bad_email}\033[0m]
GOOD       = [\033[1;34m{good_ig}\033[0m]
\033[0m
"""
...
def check_gmail(email):
    ...
    try:
        ...
        if '"gf.uar",1' in response.text:
            hits += 1
            update_stats()
            full_email = email + pyraza_domain
...
def rest(user):
    try:
        ...
        razaporno = response.get('email', 'Reset None')
    except:
        razaporno = 'Reset None'
    return razaporno
...
"""
    ...
    # For Markdown formatting in Telegram
    formatted_text = info_text.replace('*', '**')
    
    with open('raza.txt', 'a') as f:
        f.write(formatted_text + "\n")
    
    try:
        requests.get(f"https://api.telegram.org/bot{TOKEN}/sendMessage?chat_id={ID}&text={formatted_text}")
    except Exception as e:
...
for _ in range(100):
    Thread(target=raza_python).start()
